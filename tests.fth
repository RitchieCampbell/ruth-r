...
420 " [“Ruth”, “Laura”, “Sarah”, ”Eleanor”, ”Eleanor”] ▷ ({“Sarah”} ∪ {“Eleanor”})" PdomainRestrictedSet SWAP doubleSpaceRemover SWAP " STRING [ " " Ruth" addQuotes1 AZ^ " , " AZ^ " Laura" addQuotes1 AZ^ " , " AZ^ " Sarah" addQuotes1 AZ^ "  , " AZ^ " Eleanor" addQuotes1 AZ^ " , " AZ^ " Eleanor" addQuotes1 AZ^ " ] STRING { " AZ^ " Sarah" addQuotes1 AZ^ " , } STRING { " AZ^ " Eleanor" addQuotes1 AZ^ " , } ∪ ▷" AZ^ doubleSpaceRemover " STRING STRING PROD POW" checkOutputAndType
