...
804 " ¬greater(  1   ,  2)" PnotBoolean " 1 2 greater ¬" boolean checkOutputAndType
806 " (¬greater(  1   ,  2))" PbooleanAtom " 1 2 greater ¬" boolean checkOutputAndType
807 " ¬greater(  1   ,  2)" Pnot " 1 2 greater ¬" boolean checkOutputAndType
809 " (¬TRUE)" PnotBoolean " TRUE ¬" boolean checkOutputAndType
810 " (¬TRUE)" Pnot " TRUE ¬" boolean checkOutputAndType
811 " ¬TRUE" PnotBoolean " TRUE ¬" boolean checkOutputAndType
812 " ¬TRUE" Pnot " TRUE ¬" boolean checkOutputAndType
813 " (¬true)" Patom " TRUE ¬" boolean checkOutputAndType
814 " ¬true" Pboolean " TRUE ¬" boolean checkOutputAndType
815 " ¬true" Pexpression " TRUE ¬" boolean checkOutputAndType
816 " (¬FALSE)" PbooleanAtom " FALSE ¬" boolean checkOutputAndType
...
822 " ¬false" Pboolean " FALSE ¬" boolean checkOutputAndType
823 " ¬false" Pexpression " FALSE ¬" boolean checkOutputAndType
824 " (¬b)" PbooleanAtom        " b ¬"     boolean checkOutputAndType
825 " ¬1 = 2" Pexpression       " 1 2 = ¬" boolean checkOutputAndType
826 " (¬1 = 2)" Patom           " 1 2 = ¬" boolean checkOutputAndType
827 " ¬1 = 2" Pboolean          " 1 2 = ¬" boolean checkOutputAndType
828 " ¬(1 = 2)" Pnotboolean    " 1 2 = ¬" boolean checkOutputAndType
829 " (¬1 = 2)" PbooleanAtom     " 1 2 = ¬" boolean checkOutputAndType
830 " ¬(1 = 2)" Pboolean        " 1 2 = ¬" boolean checkOutputAndType
...
832 " (¬“Campbell” = “Ruth”)" Patom  SWAP doubleSpaceRemover SWAP
" Campbell" addQuotes1 " Ruth" addQuotes1 " stringEq ¬" AZ^ AZ^ boolean checkOutputAndType
