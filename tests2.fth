...
300 " 1↦“Campbell”" Ppair " 1 " quotespace " Campbell" quotespace "  |->I,$" AZ^ AZ^ AZ^ AZ^ " INT STRING PROD" checkOutputAndType 300 .
...
329 " ({“Campbell”, (“Bill”)} \  {“Steve”})" Pexpression  SWAP doubleSpaceRemover nowspace SWAP  " STRING { " " Campbell" addQuotes1 AZ^ " , " AZ^ " Bill" addQuotes1 AZ^ " , } STRING { " AZ^ " Steve" addQuotes1 AZ^ " , } \ " AZ^ nowspace " STRING POW" checkOutputAndType 325 .
...
354 " [“Campbell”, “Bill”] ⊕ {97 ↦ “Steve”}" PjoinedSet SWAP doubleSpaceRemover SWAP " STRING [ " " Campbell" addQuotes1 AZ^ "  , " AZ^ " Bill" addQuotes1 AZ^ "  , ] INT STRING PROD  { 97 " AZ^ " Steve" addQuotes1 AZ^ " |->I,$ , } ⊕" AZ^ doubleSpaceRemover " INT STRING PROD POW" checkOutputAndType 350 . " [
...
379 " (({97, 98, 99}) ◁- [(“Campbell”), “Bill”] )" PdomainRestrictedSet SWAP doubleSpaceRemover SWAP " INT { 97 , 98 , 99 , } STRING [ " " Campbell" addQuotes1 AZ^ " , " AZ^ " Bill" addQuotes1 AZ^ "  , ] ◁-" AZ^ doubleSpaceRemover " INT STRING PROD POW" checkOutputAndType 375 .
